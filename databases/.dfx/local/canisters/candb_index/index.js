...
import { idlFactory } from './candb_index.did.js';
export { idlFactory } from './candb_index.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_CANDB_INDEX;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./candb_index.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the candb_index canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./candb_index.did.js")._SERVICE>}
 */
export const candb_index = createActor(canisterId);
