...
import { idlFactory } from './map.did.js';
export { idlFactory } from './map.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_MAP;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./map.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the map canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./map.did.js")._SERVICE>}
 */
export const map = createActor(canisterId);
