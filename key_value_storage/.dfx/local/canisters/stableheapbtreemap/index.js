...
import { idlFactory } from './stableheapbtreemap.did.js';
export { idlFactory } from './stableheapbtreemap.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_STABLEHEAPBTREEMAP;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./stableheapbtreemap.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the stableheapbtreemap canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./stableheapbtreemap.did.js")._SERVICE>}
 */
export const stableheapbtreemap = createActor(canisterId);
