...
import { idlFactory } from './Trie.did.js';
export { idlFactory } from './Trie.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_TRIE;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./Trie.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the Trie canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./Trie.did.js")._SERVICE>}
 */
export const Trie = createActor(canisterId);
