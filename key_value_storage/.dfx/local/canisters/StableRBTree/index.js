...
import { idlFactory } from './StableRBTree.did.js';
export { idlFactory } from './StableRBTree.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_STABLERBTREE;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./StableRBTree.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the StableRBTree canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./StableRBTree.did.js")._SERVICE>}
 */
export const StableRBTree = createActor(canisterId);
