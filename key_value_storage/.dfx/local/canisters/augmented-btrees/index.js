...
import { idlFactory } from './augmented-btrees.did.js';
export { idlFactory } from './augmented-btrees.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_AUGMENTED_BTREES;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./augmented-btrees.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the augmented-btrees canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./augmented-btrees.did.js")._SERVICE>}
 */
export const augmented_btrees = createActor(canisterId);
