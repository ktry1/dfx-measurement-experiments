...
import { idlFactory } from './memory-hashtable.did.js';
export { idlFactory } from './memory-hashtable.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_MEMORY_HASHTABLE;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./memory-hashtable.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the memory-hashtable canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./memory-hashtable.did.js")._SERVICE>}
 */
export const memory_hashtable = createActor(canisterId);
