//Dependencies
import { idlFactory, stableheapbtreemap } from '../../../src/declarations/stableheapbtreemap';
...
async function main() {
    ...
    //======================================
    await startDfx();
    const canisterName = "stableheapbtreemap";
    //Getting identity
    ...
    const actor: typeof stableheapbtreemap = makeActor(agent, idlFactory, canisterId);
