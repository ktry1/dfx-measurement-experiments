//Dependencies
import {idlFactory, linked_list} from "../../src/declarations/linked-list";
...
async function main() {
    ...
    //======================================
    await startDfx();
    const canisterName = "linked-list";
    //Getting identity
    ...
    const actor: typeof linked_list = makeActor(agent, idlFactory, canisterId);
