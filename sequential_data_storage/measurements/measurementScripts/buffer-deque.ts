//Dependencies
import {idlFactory, buffer_deque} from "../../src/declarations/buffer-deque";
...
async function main() {
    ...
    //======================================
    await startDfx();
    const canisterName = "buffer-deque";
    //Getting identity
    ...
    const actor: typeof buffer_deque = makeActor(agent, idlFactory, canisterId);
    ...
    saveToExcel(`./measurements/results/${canisterName}.xlsx`, ["Add", "Read", "Update", "Delete", "TransformToArray"], headers, testResults);
